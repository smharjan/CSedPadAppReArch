...
/**
 *
 * When the session destroyed, MySessionListener will do necessary logout operations. Later, at the first request of
 * client, this filter will be fired and redirect the user to the appropriate timeout page if the session is not valid.
 *
 * @author hturksoy
 *
 */
public class SessionTimeoutFilter implements Filter {
        ...
        if ((request instanceof HttpServletRequest) && (response instanceof HttpServletResponse)) {
            ...
            if (isSessionControlRequiredForThisResource(httpServletRequest)) {
                ...
                if (isSessionInvalid(httpServletRequest)) {
                    ...
                    System.out.println("Session is invalid - time out!!");
    ...
    private boolean isSessionControlRequiredForThisResource(HttpServletRequest httpServletRequest) {
        ...
        boolean controlRequired = !(requestPath.contains(getTimeoutPage())); //!StringUtils.contains(requestPath, getTimeoutPage()); //
