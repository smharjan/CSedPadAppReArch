...
public class Expectation implements Comparable<Expectation>{
	...
	private String matchedSentenceInInputText;
	//--------------------------------------------------------------------------------------
	...
	public boolean matches(String input, float threshold)
	{
		...
		//Dan: we need to initialize the max value to the already computed similarity 
	...
	public String getMatchedSentenceInInputText()
	{
		return matchedSentenceInInputText;
	}

	public void setMatchedSentenceInInputText(String matchedSentenceInInputText)
	{
		this.matchedSentenceInInputText = matchedSentenceInInputText;
	}
}
